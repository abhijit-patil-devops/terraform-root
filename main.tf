...
# ── VPC ──────────────────────────────────────────────────────────────
module "vpc" {
  source = "https://github.com/abhijit-patil-devops/terraform-module-vpc.git"
...
module "subnets" {
  source = "https://github.com/abhijit-patil-devops/terraform-module-subnet.git"
...
module "ec2_instances" {
  source = "https://github.com/abhijit-patil-devops/terraform-module-ec2.git"
...
# ── S3 Bucket ─────────────────────────────────────────────────────────
module "s3_bucket" {
  source = "https://github.com/abhijit-patil-devops/terraform-module-s3.git"
